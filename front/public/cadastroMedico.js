...
con.connect(function(error) {
  ...
  var sql = "insert into medico(nome, email, senha, confirmar-senha, crm, especialidade) values (?, ?, ?, ?, ?, ?)";
...
setTimeout(function () {
  window.location.href = 'loginMedico.html'; // Redirecionar para a página de loginMedico.html
